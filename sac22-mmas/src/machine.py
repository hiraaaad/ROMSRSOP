...
class Machine():
    ...
    def __repr__(self):
        # return f'Agent(utility={self.total_utility}, penalty_solution={self.total_penalty_solution}, penalty_parcel={self.total_penalty_parcel})'
    ...
    def __init__(self,problem,id_machine):
        ...
        # self.data_export = {'time':[], 'machine':[], 'cut':[], 'direction':[], 'type':[], 'num_req':[], 'utility':[],
        #                     'chemical_1':[], 'chemical_2':[], 'chemical_3':[], 'chemical_4':[], 'chemical_5':[], 'chemical_6':[]}
        # save rng seed
